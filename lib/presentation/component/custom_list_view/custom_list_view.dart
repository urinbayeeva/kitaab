...
import 'package:kitaab/presentation/component/custom_pagination.dart';
import 'package:kitaab/presentation/component/shimmer_view.dart';
      ...
      child: Builder(builder: (context) {
        if (widget.status.isInitial) {
          ...
          return CustomErrorWidget(
            ...
            subtitle: widget.errorMessage ?? "something_wrong_subtitle".tr(),
            icon: widget.errorIcon ?? IconSet.create.emojiSadD,
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: fonts.paragraphP1Regular
              ...
              if (errorWidgetModel!.buttonText != null)
                Builder(builder: (context) {
                  if (errorWidgetModel!.isFocusedButton) {
                    return CustomButton(
                        titleStyle: fonts.paragraphP1SemiBold
